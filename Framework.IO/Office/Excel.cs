...
namespace Framework.IO.Office
{
    public class Excel : IDisposable
    {
        ...
        {
            return
                type.GetPropertiesByAttribute<Framework.IO.Attributes.ExportAttribute>();
        }

        private IEnumerable<PropertyInfo> GetImportableProperties(Type type)
        {
            return
                type.GetPropertiesByAttribute<Framework.IO.Attributes.ImportAttribute>();
        }
